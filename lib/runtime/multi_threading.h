 ...
 * @Author: Qiming Zheng
 * @Date: 2022-01-24 18:21:33
 * @Last Modified by: Qiming Zheng
 * @Last Modified time: 2022-01-24 21:30:29
...
void InitializeMultiThreading(std::vector<int> dim);

template <typename F, typename... Args>
auto SubmitToLevel(F &&f, Args &&...args, int level)
    -> std::future<decltype(f(args...))> {
  return ThreadPool::GetThreadingLevel(level)->submit(f, args...);
}
